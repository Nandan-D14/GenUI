...
const Hero = () => (
  <section className="relative min-h-screen pt-32 pb-20 flex flex-col items-center justify-center text-center px-4 overflow-hidden">
    {/* Background Texture */}
...
const FeatureGrid = () => (
  <section className="relative z-10 px-4 md:px-8 max-w-[1400px] mx-auto mb-32">
